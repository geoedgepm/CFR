...
-- Started on 2016-09-22 21:08:21 IST
...
COPY incident_user_choices (id, question_id, choice_id, incident_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('incident_user_choices_id_seq', 1, false);
...
-- Completed on 2016-09-22 21:08:21 IST
